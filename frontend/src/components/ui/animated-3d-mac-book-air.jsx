/**
 * ==========================================
 * ANIMATED 3D MACBOOK AIR COMPONENT
 * ==========================================
 * 
 * PURPOSE: Hero visual element for Admin Dashboard
 * WHY: Provides engaging, professional 3D animation
 * TECH: CSS 3D transforms with keyframe animations
 * 
 * This component creates a 3D animated MacBook Air model
 * that rotates and animates on page load, serving as
 * the centerpiece of the admin welcome dashboard.
 */
